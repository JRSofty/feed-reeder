...
CREATE TABLE `group_feed`(
	...
	CONSTRAINT `fk_gf_uid` FOREIGN KEY (user_id) REFERENCES user (id)
)ENGINE = InnoDB;
...
CREATE TABLE `web_feed`(
	...
	CONSTRAINT `fk_wf_uid` FOREIGN KEY (user_id) REFERENCES user (id)
)ENGINE = InnoDB;
...
CREATE TABLE `feed_item`(
	...
	CONSTRAINT `fk_fi_uid` FOREIGN KEY (user_id) REFERENCES user (id)
)ENGINE = InnoDB;
